...
public class SpotsDialog extends AlertDialog {
    ...
    public static class Builder {
        ...
        public AlertDialog build() {
            return new com.autumntechcreation.click4panditcustomer.loader.SpotsDialog(
                    context,
    ...
    private int size;
    private com.autumntechcreation.click4panditcustomer.loader.AnimatedView[] spots;
    private com.autumntechcreation.click4panditcustomer.loader.AnimatorPlayer animator;
    ...
    protected void onStart() {
        ...
        for (com.autumntechcreation.click4panditcustomer.loader.AnimatedView view : spots) view.setVisibility(View.VISIBLE);

        animator = new com.autumntechcreation.click4panditcustomer.loader.AnimatorPlayer(createAnimations());
        animator.play();
    }
    ...
    private void initProgress() {
        com.autumntechcreation.click4panditcustomer.loader.ProgressLayout progress = findViewById(R.id.dmax_spots_progress);
        size = progress.getSpotsCount();

        spots = new com.autumntechcreation.click4panditcustomer.loader.AnimatedView[size];
        ...
        for (int i = 0; i < spots.length; i++) {
            com.autumntechcreation.click4panditcustomer.loader.AnimatedView v = new com.autumntechcreation.click4panditcustomer.loader.AnimatedView(getContext());
    ...
    private Animator[] createAnimations() {
        ...
        for (int i = 0; i < spots.length; i++) {
            final com.autumntechcreation.click4panditcustomer.loader.AnimatedView animatedView = spots[i];
            Animator move = ObjectAnimator.ofFloat(animatedView, "xFactor", 0, 1);
            move.setDuration(DURATION);
            move.setInterpolator(new com.autumntechcreation.click4panditcustomer.loader.HesitateInterpolator());
