...
public class PujaBrassItemDetailsRepository {
    ...
    @Inject
    public PujaBrassItemDetailsRepository(AppExecutors appExecutors, Webservice webservice, SharedPrefsHelper sharedPrefsHelper) {
