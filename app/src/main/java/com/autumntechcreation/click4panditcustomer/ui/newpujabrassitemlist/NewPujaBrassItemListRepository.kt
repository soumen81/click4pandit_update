...
class NewPujaBrassItemListRepository @Inject constructor(
    ...
    fun getAddtoCartBuyNowForPujaBrass(prodMasterId: Int,productPrice:Int): LiveData<Resource<NewPujaItemKitAddtoCartOrBuyNowModel>>?{
    ...
    fun getAddItemForWishPujaBrassListItem(prodMasterId:Int,prodCustWishLisQty:Int,prodCustscWishListRate:Double): LiveData<Resource<AddWishListItemModel>>?{
