...
public class PujaBrassItemListingRepository {
    ...
    @Inject
    public PujaBrassItemListingRepository(AppExecutors appExecutors, Webservice webservice, SharedPrefsHelper sharedPrefsHelper) {
