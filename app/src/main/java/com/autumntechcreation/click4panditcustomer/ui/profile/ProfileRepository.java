    ...
    public LiveData<Resource<CustomerGetProfileModel>> getProfileImageUpload(String fileName,String cloudFileName,String imgAction,
        ...
        return new NetworkBoundResource<CustomerGetProfileModel,CustomerGetProfileModel>(mAppExecutors) {
            ...
            protected LiveData<ApiResponse<CustomerGetProfileModel>> createCall() {
                ...
                Log.e("URL",url);
                JsonObject jsonObject = new JsonObject();
                jsonObject.addProperty(AllUrlsAndConfig.CUSTMASTERPROFILEIMGID, str);
                jsonObject.addProperty(AllUrlsAndConfig.CUSTMASID, str);
                jsonObject.addProperty(AllUrlsAndConfig.LOGGEDID, getEmail());
                jsonObject.addProperty(AllUrlsAndConfig.UPDATESTAM, str);
                jsonObject.addProperty(AllUrlsAndConfig.UPDTEUSER, str);
                jsonObject.addProperty(AllUrlsAndConfig.ORGSTAMPP, str);
                jsonObject.addProperty(AllUrlsAndConfig.ORGUSERR, str);
                jsonObject.addProperty(AllUrlsAndConfig.DELLFLG, "N");
