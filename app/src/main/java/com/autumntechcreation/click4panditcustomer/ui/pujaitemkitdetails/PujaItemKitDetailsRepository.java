...
public class PujaItemKitDetailsRepository {
    ...
    @Inject
    public PujaItemKitDetailsRepository(AppExecutors appExecutors, Webservice webservice, SharedPrefsHelper sharedPrefsHelper) {
