...
class NewPujaItemKitListRepository @Inject constructor(
    ...
    fun getAddItemForWishListItem(prodMasterId:Int,prodCustWishLisQty:Int,prodCustscWishListRate:Double): LiveData<Resource<AddWishListItemModel>>?{
